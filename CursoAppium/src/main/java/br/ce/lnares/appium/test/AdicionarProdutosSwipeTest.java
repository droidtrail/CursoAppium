...
import br.ce.lnares.appium.page.AdicionarProdutosSwipePage;

public class AdicionarProdutosSwipeTest extends BaseTest {

	private AdicionarProdutosSwipePage add = new AdicionarProdutosSwipePage();
